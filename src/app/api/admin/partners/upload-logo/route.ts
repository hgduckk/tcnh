...
export const metadata = {
  name: "Upload Partner Logo",
  description: "Upload partner logo to Supabase Storage (converts to WebP)",
};
...
export async function POST(request: Request) {
  try {
    ...
    const providedId = formData.get("partnerId") as string | null;
    ...
    const partnerId = isUuid(providedId) ? providedId : randomUUID();
    ...
    const objectPath = `${partnerId}/logo.webp`;
